...
t1=Thread(target=(create or read or delete),args=("Rohit,70,3600)) #as per the operation
t1.start()
t1.sleep()
t2=Thread(target=(create or read or delete),args=("Harsh",56,4000)) #as per the operation
t2.start()
t2.sleep()
#and so on upto tn
